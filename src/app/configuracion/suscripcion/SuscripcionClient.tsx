...
import { CheckCircle2, FileSignature, ShieldCheck, Zap } from 'lucide-react'
import { Badge } from '@/components/ui/badge'

export default function SuscripcionClient({ initialGymInfo }: { initialGymInfo: any }) {
  const gymInfo = initialGymInfo
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start">
            ...
            <Card className="border-primary/50 bg-black/60 shadow-2xl relative">
              ...
              <CardHeader className="text-center pb-4 relative z-10">
                ...
                <div className="my-6">
                  <span className="text-5xl font-black italic tracking-tighter text-white">$390.000</span>
