...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Administración' Entrar card to open the admin login page (element index 93).
        # link "Administración Gestión total pre-configu..."
        elem = page.locator("xpath=/html/body/div[2]/div[4]/div[2]/a[2]").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the admin email field, fill the password field, then submit the login form.
