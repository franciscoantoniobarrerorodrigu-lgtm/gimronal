...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Soy Socio' member portal link to open the member login page (element index 76).
        # link "Soy Socio Accede a tu historial y verifi..."
        elem = page.locator("xpath=/html/body/div[2]/div[4]/div[2]/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the document and password fields with the member credentials (1052075884 / 1052075884), submit the form, then search the resulting page for the membership status (e.g., 'Activo') and for an expiration indicator (e.g., 'Vencim'/'Venc...
